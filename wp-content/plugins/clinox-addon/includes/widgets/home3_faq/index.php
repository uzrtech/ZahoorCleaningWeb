...
class clefix_home3_faq extends Widget_Base {

    public function get_name() {
        return 'clenfix-home3-faq';
    } 

    public function get_title() {
        return   esc_html__('FAQ 3', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_home3_faq());