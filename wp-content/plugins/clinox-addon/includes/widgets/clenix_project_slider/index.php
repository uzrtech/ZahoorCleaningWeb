...
class clefix_project_slider_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-project-slider';
    } 

    public function get_title() {
        return   esc_html__('Project slider', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_project_slider_widget());