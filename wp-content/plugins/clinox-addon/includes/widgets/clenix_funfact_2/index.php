...
class clefix_funfact_widget_2 extends Widget_Base {

    public function get_name() {
        return 'clenfix-funfact-2';
    } 

    public function get_title() {
        return   esc_html__('Funfact 2', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_funfact_widget_2());