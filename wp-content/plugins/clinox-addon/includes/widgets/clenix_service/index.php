...
class clefix_service_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix_service';
    } 

    public function get_title() {
        return   esc_html__('Clenix service', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_service_widget());