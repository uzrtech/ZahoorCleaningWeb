...
class clefix_home3_client extends Widget_Base {
    ...
    public function get_title() {
        return   esc_html__('Client 3', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_home3_client());