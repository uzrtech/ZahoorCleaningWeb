...
class clefix_header_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-header';
    } 

    public function get_title() {
        return   esc_html__('Header', 'clenfix');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'img-sticky', [
                ...
                'label_block' => true,                
                'label' =>   esc_html__('Logo sticky', 'clenfix'), 
            ] 
        ); 
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_header_widget());