...
class ap_abt_1_sx extends Widget_Base {
    ...
    public function get_title() {
        return   esc_html__('Clenix feature', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\ap_abt_1_sx());