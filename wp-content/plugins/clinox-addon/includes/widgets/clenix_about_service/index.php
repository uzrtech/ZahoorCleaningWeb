...
class clefix_about_service_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-about-service';
    } 

    public function get_title() {
        return   esc_html__('About service', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_about_service_widget());