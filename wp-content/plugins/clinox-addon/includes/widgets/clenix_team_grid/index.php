...
class clefix_team_grid_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-team-grid';
    } 

    public function get_title() {
        return   esc_html__('Team grid', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_team_grid_widget());