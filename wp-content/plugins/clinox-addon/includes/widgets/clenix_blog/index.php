...
class clefix_blog_widget extends Widget_Base {
    ...
    public function get_title() {
        return   esc_html__('Blog', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_blog_widget());