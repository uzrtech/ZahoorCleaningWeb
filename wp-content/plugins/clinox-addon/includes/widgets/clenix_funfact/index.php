...
class clefix_funfact_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-funfact';
    } 

    public function get_title() {
        return   esc_html__('Funfact', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_funfact_widget());