...
class clefix_testimonial_grid_widget extends Widget_Base {

    public function get_name() {
        return 'clenfix-testimonial-grid';
    } 

    public function get_title() {
        return   esc_html__('Testimonial grid', 'clenfix');
    }
 ...
 $widgets_manager->register_widget_type(new \WebangonAddon\Widgets\clefix_testimonial_grid_widget());