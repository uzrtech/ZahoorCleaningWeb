=== Hostinger Affiliate Marketing Tools ===
Tags: Amazon, Affiliate, Mercado Libre, Marketing
Requires PHP: 8.0
Tested up to: 6.5
Stable tag: 3.0.21
...
The Hostinger Affiliate Marketing Tools plugin simplifies affiliate marketing for WordPress users.

== Installation ==

This section describes how to install the plugin and get it working.

1. Upload `hostinger-affiliate-plugin` folder to the `/wp-content/plugins/` directory
...
2.0.20 (2025-01-27)
- Clean orhpaned products on fetch
...
3.0.7 (2025-06-19)
- Fix AR, MX mercado marketplace links in dropdown
- Remove Argentina option from country dropdown.
- Fix no message in Mercado Livre settings when successfully saved
- Fix marketplace selection screen is displayed after plugin update
...
3.0.9 (2025-07-17)
- Style changes
- Fixed packages assets load

3.0.10 (2025-07-29)
- Added translations
- Fixed Amazon affiliate program URLs
- Fixed Save settings button state when not all mandatory fields are filled
- Fixed handling of products that have slash in their id (Mercado)

3.0.11 (2025-07-31)
- Fix product fetching Mercado Livre Mexico

3.0.12 (2025-08-25)
- Added ASIN pull limit
- Fixed issue not showing products in search results
- Fixed issue with storing amazon tag inside DB

3.0.13 (2025-09-01)
- Dev: Development changes
- Fix: Assets scripts loading in the editor
...
- Dev: Development changes
- Dev: Dependency updates
- Fix: Reverted assets split change
- Feat: Added latest translations

3.0.16 (2025-09-08)
- Dev: Dependency updates
- Feat: Added error handling for settings update

3.0.17 (2025-09-18)
- Refactor: Amazon secret key validation function

3.0.18 (2025-09-23)
- Fix: Mercado product search
- Dev: Assets compilation improvements

3.0.19 (2025-09-30)
- Fix: Product selection in product search modal
- Tweak: Optimize assets loading
- Tweak: Bump dependencies
- Dev: Fix Release updater

3.0.20 (2025-10-07)
- Fix: Hide product review count if empty

3.0.21 (2025-10-16)
- Feature: Added latest translations
